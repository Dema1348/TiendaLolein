<%-- 
    Document   : sobre
    Created on : 14-09-2014, 23:24:10
--%>
    ...
    <div class="cuerpo">
       ...
       <% if(sesion.getAttribute("usuario")==null){
        ...
        <div class="contenido">
            ...
            <div class="nosotros">
                <p>Somos diseño, comodidad y la búsqueda permanente de la mejor calidad. Apreciamos el arte del buen gusto, siempre ilimitado para aquellas cuya finalidad es la permanente creación.</p>

               <p>Nuestras colecciones se basan en la novedad y armonía de cada uno de nuestros diseños, siempre fieles a un estilo propio.</p>

                <p>Al mismo tiempo somos oído y ojos de las necesidades de nuestras clientes; definitivamente especiales, concretas y directas.</p>

                <p>En Romano todos los días trabajamos para superar nuestro propio pasado, buscando en las nuevas tendencias la definición de nuestras nuevas propuestas. Por último, nos gusta saber que somos tu elección.</p>
